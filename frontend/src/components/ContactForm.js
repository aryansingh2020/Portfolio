            ...
            <form onSubmit={handleSubmit} className="contact-form flex flex-col items-center gap-[1dvh]">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="block text-white rounded-md w-[40dvh] sm:w-[60dvh] h-[7dvh] bg-transparent border-[0.5dvh] border-yellow-400"
                        required
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="block text-white rounded-md w-[40dvh] sm:w-[60dvh] max-h-[20dvh] bg-transparent border-[0.5dvh] border-yellow-400"
                        required
                    ></textarea>
                </div>
