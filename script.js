document.addEventListener("DOMContentLoaded", () => {
    ...
    const projectPara = "1. The Real Estate Web App is a web application built using React, a popular JavaScript library for building user interfaces. This project is designed to help users search for real estate properties, view property details, and make inquiries.<br>2. The Color Picker Web App is a user-friendly web application developed using React. It helps users select and explore colors, making it useful for designers, artists, and anyone working with color.<br>3. The Calculator project is a simple web-based calculator built using HTML, CSS, and JavaScript. It provides basic mathematical functions such as addition, subtraction, multiplication, and division. Please visit my Github profile for more details.";
    description.innerHTML=skillPara;
    ...
    navBtn.forEach((button) => {
        button.addEventListener("click", () => {
            ...
            if (buttonText === "Skills") {
                ...
                description.innerHTML = projectPara;      
                navBtn[currentPos].style.color="#ffffff";
                navBtn[currentPos].style.backgroundColor="transparent";
                currentPos = 1;
                navBtn[currentPos].style.color="black";
    ...
    leftBtn.addEventListener("click", () => {
        if (currentPos === 0) {
            ...
            description.innerHTML = contents[currentPos].desc;
        }
        else {
            navBtn[currentPos].style.color="white";
            navBtn[currentPos].style.backgroundColor="transparent";
